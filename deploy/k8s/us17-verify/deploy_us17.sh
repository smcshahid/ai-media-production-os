#!/usr/bin/env bash
# Import US-17 API + worker images and rollout on Olares.
set -euo pipefail
NS=aimpos-mwayolares
API_IMAGE="${AIMPOS_API_IMAGE:-docker.io/library/aimpos-api:us17}"
WORKER_IMAGE="${AIMPOS_WORKER_IMAGE:-docker.io/library/aimpos-worker:us17}"
